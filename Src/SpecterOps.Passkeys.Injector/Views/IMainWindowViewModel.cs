...
public interface IMainWindowViewModel : INotifyPropertyChanged
{
    ...
    /// <summary>Gets or sets the callback used to show the assertion dialog.</summary>
    EventHandler? CredentialRequested { get; set; }

    /// <summary>Gets or sets the callback used to show the attestation dialog.</summary>
    EventHandler? CredentialCreationRequested { get; set; }
